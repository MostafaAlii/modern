...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('assets/admin/css-rtl/core/menu/menu-types/vertical-content-menu.css')}}">
...
<script src="{{asset('assets/admin/vendors/js/ui/headroom.min.js')}}" type="text/javascript"></script>

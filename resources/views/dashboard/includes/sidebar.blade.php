        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
              ...
              <li class="nav-item">
                     <a href="">
                            ...
                            <span class="menu-title" data-i18n="nav.add_on_drag_drop.main">
                                   {{ trans('admin.mainSettings_in_sidebar') }}
                            </span>
                     </a>
              </li>
              ...
              <li class="nav-item">
                     <a href="">
                            ...
                            <span class="menu-title" data-i18n="nav.dash.main">
                                   {{ trans('admin.mainAdmins_in_sidebar') }}
                            </span>
                            <span class="badge badge badge-dark badge-pill float-right mr-2">{{ App\Models\Admin::count() }}</span>
                     </a>
                     ...
                     <ul class="menu-content">
                            <li>
                                   <a class="menu-item" href="{{ route('admin.create') }}" data-i18n="nav.dash.crypto">
                                          ...
                                          {{ trans('admin.addNew_mainAdmins_in_sidebar') }}
                                   </a>
                            </li>
                            <li class="">
              ...
              <li class="nav-item">
                     <a href="">
                            <i class="la la-language"></i>
                            <span class="menu-title" data-i18n="nav.dash.main">
                                   {{ trans('admin.mainLanguages_in_sidebar') }}
                            </span>
                     ...
                     <ul class="menu-content">
                            <li>
                                   <a class="menu-item" href="" data-i18n="nav.dash.crypto">
                                          <i class="la la-plus-circle"></i>
                                          {{ trans('admin.addNew_mainLanguages_in_sidebar') }}
                                   </a>
                            </li>
                            <li class="">
                                   <a class="menu-item" href="" data-i18n="nav.dash.ecommerce">
                                          <i class="la la-language"></i>
                                          {{ trans('admin.showAll_mainLanguages_in_sidebar') }}
                                   </a>
                            </li>
                     </ul>
              ...
              <li class="nav-item">
                     <a href="">
                            ...
                            <span class="menu-title" data-i18n="nav.dash.main">
                                   {{ trans('admin.mainCategories_in_sidebar') }}
                            </span>
                     ...
                     <ul class="menu-content">
                            <li>
                                   <a class="menu-item" href="" data-i18n="nav.dash.crypto">
                                          <i class="la la-plus-circle"></i>
                                          {{ trans('admin.add_mainCategories_in_sidebar') }}
                                   </a>
                            </li>
                            <li class="">
                                   <a class="menu-item" href="" data-i18n="nav.dash.ecommerce">
                                          <i class="la la-database"></i>
                                          {{ trans('admin.showAll_mainCategories_in_sidebar') }}
                                   </a>
                            </li>
                     </ul>
              </li>

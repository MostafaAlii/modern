            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="">
                        ...
                        <h3 class="brand-text text-bold">{{ trans('admin.app_branding_name') }}</h3>
                    </a>
                </li>
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            ...
                            <img style="height: 35px;" src="{{ asset('assets/admin/images/avatar.jpg') }}" alt="avatar">
                                <i></i>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="">
                                <i class="la la-cog"></i>
                                {{ trans('admin.user_settings') }}
                            </a>
                            <div class="dropdown-divider"></div>
                            <a href="{{ route('admin.logout') }}" class="dropdown-item" href=""><i class="ft-power"></i>{{ trans('admin.logout') }}</a>
                        </div>
                    </li>

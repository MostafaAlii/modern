            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="">
                        <img class="brand-logo" alt="modern admin logo" src="<?php echo e(asset('assets/admin/images/logo/logo.png')); ?>">
                        <h3 class="brand-text text-bold"><?php echo e(trans('admin.app_branding_name')); ?></h3>
                    </a>
                </li>
                ...
                <ul class="nav navbar-nav float-right">
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="mr-1">
                                <?php echo e(trans('admin.welcome_user_text')); ?> | 
                                <span class="user-name text-bold-700"><?php echo e(auth()->user()->name); ?></span>
                            </span>
                            <span class="avatar avatar-online">
                            <img style="height: 35px;" src="<?php echo e(asset('assets/admin/images/avatar.jpg')); ?>" alt="avatar">
                                <i></i>
                            </span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="">
                                <i class="ft-user"></i>
                                <?php echo e(trans('admin.user_profile')); ?>

                            </a>
                            <a class="dropdown-item" href="">
                                <i class="la la-cog"></i>
                                <?php echo e(trans('admin.user_settings')); ?>

                            </a>
                            <div class="dropdown-divider"></div>
                            <a href="<?php echo e(route('admin.logout')); ?>" class="dropdown-item" href=""><i class="ft-power"></i><?php echo e(trans('admin.logout')); ?></a>
                        </div>
                    </li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    <span class="grey darken-2"><?php echo e(trans('admin.notifications')); ?></span>
                                </h6>
                                <span
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                            <li class="dropdown-menu-header">
                                <h6 class="dropdown-header m-0">
                                    <span class="grey darken-2"><?php echo e(trans('admin.messages')); ?></span>
                                </h6>
                                <span
...
</nav><?php /**PATH C:\xampp\htdocs\modern\resources\views/dashboard/includes/header.blade.php ENDPATH**/ ?>
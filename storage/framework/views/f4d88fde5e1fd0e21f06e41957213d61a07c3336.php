        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
              ...
              <li class="nav-item">
                     <a href="">
                            ...
                            <span class="menu-title" data-i18n="nav.add_on_drag_drop.main">
                                   <?php echo e(trans('admin.mainSettings_in_sidebar')); ?>
              ...
              <li class="nav-item">
                     ...
                     <ul class="menu-content">
                            ...
                            <li class="">
                                   <a class="menu-item" href="<?php echo e(route('admin.admins')); ?>" data-i18n="nav.dash.ecommerce">
                                          <i class="la la-language"></i>
                                          <?php echo e(trans('admin.showAll_mainAdmins_in_sidebar')); ?>

                                   </a>
                            </li>
                     </ul>
                     <!-- End Admins Dropdown Menu -->
              </li>
              <!-- End Admins Tab -->
              ...
              <li class="nav-item">
                     <a href="">
                            <i class="la la-language"></i>
                            <span class="menu-title" data-i18n="nav.dash.main">
                                   <?php echo e(trans('admin.mainLanguages_in_sidebar')); ?>

                            </span>
                            <span class="badge badge badge-info badge-pill float-right mr-2">0</span>
                     </a>
                     <!-- Start Languages Dropdown Menu -->
                     <ul class="menu-content">
                            <li>
                                   <a class="menu-item" href="" data-i18n="nav.dash.crypto">
                                          <i class="la la-plus-circle"></i>
                                          <?php echo e(trans('admin.addNew_mainLanguages_in_sidebar')); ?>
                            ...
                            <li class="">
                                   <a class="menu-item" href="" data-i18n="nav.dash.ecommerce">
                                          <i class="la la-language"></i>
                                          <?php echo e(trans('admin.showAll_mainLanguages_in_sidebar')); ?>

                                   </a>
                            </li>
                     </ul>
                     <!-- End Languages Dropdown Menu -->
              </li>
              <!-- End Languages Tab -->
              ...
              <li class="nav-item">
                     <a href="">
                            ...
                            <span class="menu-title" data-i18n="nav.dash.main">
                                   <?php echo e(trans('admin.mainCategories_in_sidebar')); ?>
                     ...
                     <ul class="menu-content">
                            <li>
                                   <a class="menu-item" href="" data-i18n="nav.dash.crypto">
                                          <i class="la la-plus-circle"></i>
                                          <?php echo e(trans('admin.add_mainCategories_in_sidebar')); ?>
                            ...
                            <li class="">
                                   <a class="menu-item" href="" data-i18n="nav.dash.ecommerce">
                                          <i class="la la-database"></i>
                                          <?php echo e(trans('admin.showAll_mainCategories_in_sidebar')); ?>
...
<!--End Sidebare-->
<?php /**PATH C:\xampp\htdocs\modern\resources\views/dashboard/includes/sidebar.blade.php ENDPATH**/ ?>